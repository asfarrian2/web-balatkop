                  ...
                  <div class="modal fade" id="tambah-modal" tabindex="-1" aria-labelledby="exampleModalLabel1">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="{{ Route('a.kategori')}}" method="POST">
                        @csrf
                  ...
                  <table id="zero_config" class="table table-striped table-bordered text-nowrap align-middle">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><h6 class="mb-0"> {{ $d->kategori}}</h6></td>
                        <td style="text-align:center;">
                          <a title="Edit" data-id="{{ Crypt::encrypt($d->id_kategori) }}" class="edit btn mb-1 bg-primary-subtle rounded-circle round-40 btn-sm d-inline-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#editdata" data-bs-whatever="@getbootstrap">
                              <i class="fs-5 ti ti-pencil"></i>
                          </a>
                          <a title="Hapus" data-id="{{ Crypt::encrypt($d->id_kategori) }}" class="hapus btn mb-1 bg-danger-subtle rounded-circle round-40 btn-sm d-inline-flex align-items-center justify-content-center">
                  ...
                  <div class="modal fade" id="editdata" tabindex="-1" aria-labelledby="exampleModalLabel1">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form action="{{ Route('u.kategori') }}" method="POST" id="formStore">
                        @csrf
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location = "/11475-adm/kategori/hapus/"+id_kategori
    }
  });
});
</script>
