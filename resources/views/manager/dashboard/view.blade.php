...
<body>
  <div class="toast toast-onload align-items-center text-bg-primary border-0" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-body hstack align-items-start gap-6">
      ...
      <div>
        <h5 class="text-white fs-3 mb-1">Selamat Datang</h5>
        <h6 class="text-white fs-2 mb-0">Balatkop-uk Prov. Kalsel</h6>
      </div>
                ...
                <li class="sidebar-item">
                 ...
                 <li class="sidebar-item">
                  <a href="./main/blog-detail.html" class="sidebar-link">
                    ...
                    <span class="hide-menu">Maklumat dan Pelayanan</span>
                  </a>
                </li>
                <li class="sidebar-item">
                  <a href="./main/blog-detail.html" class="sidebar-link">
                      ...
                      <div class="profile-dropdown position-relative" data-simplebar>
                        ...
                        <div class="message-body">
                          ...
                          <a href="./main/app-email.html" class="py-8 px-7 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                              <img src="{{asset ('admins/images/svgs/icon-inbox.svg') }}" alt="modernize-img" width="24" height="24" />
                            </span>
                            <div class="w-100 ps-3">
                          ...
                          <a href="./main/app-notes.html" class="py-8 px-7 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                              <img src="{{asset ('admins/images/svgs/icon-tasks.svg') }}" alt="modernize-img" width="24" height="24" />
                            </span>
                            <div class="w-100 ps-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                <div class="m-n4 unlimited-img">
                                  <img src="{{asset ('admins/images/backgrounds/unlimited-bg.png') }}" alt="modernize-img" class="w-100" />
                                </div>
                              </div>
                            </div>
                          </div>
    ...
    document.documentElement.setAttribute("data-color-theme", e);
      ...
      <div class="offcanvas customizer offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body h-n80" data-simplebar>
          ...
          <h6 class="mt-5 fw-semibold fs-4 mb-2">Arah Konten</h6>
          <div class="d-flex flex-row gap-3 customizer-box" role="group">
          ...
          <h6 class="mt-5 fw-semibold fs-4 mb-2">Warna</h6>
          ...
          <h6 class="mt-5 fw-semibold fs-4 mb-2">Garis Kartu</h6>
  ...
  <script src="{{asset ('admins/js/dashboards/dashboard.js') }}"></script>
</body>
