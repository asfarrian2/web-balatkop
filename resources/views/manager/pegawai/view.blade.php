                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                              ...
                              <input type="text" name="pegawai" class="form-control" id="recipient-name1" required/>
                            </div>
                            <div class="mb-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center;">
                          @if ($d->status == 1)
                          <a title="Nonaktifkan" data-id="{{ Crypt::encrypt($d->id_pegawai) }}" class="status btn mb-1 bg-success-subtle rounded-circle round-40 btn-sm d-inline-flex align-items-center justify-content-center">
                              <i class="fs-5 ti ti-toggle-left"></i>
                          </a>
                          @else
                          <a title="Aktifkan" data-id="{{ Crypt::encrypt($d->id_pegawai) }}" class="status btn mb-1 bg-warning-subtle rounded-circle round-40 btn-sm d-inline-flex align-items-center justify-content-center">
