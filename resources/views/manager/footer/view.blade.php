            ...
            <div class="col-md-4 col-lg-2">
              <div class="card text-center bg-white alert-dismissible fade show alert p-0 card-hover rounded-4" role="alert">
                <div class="p-2 d-block mt-3">
                  <img src="{{ asset ('assets/images/footer/'.$file->keterangan) }}" width="75" style="width: 75px; height: 75px; object-fit: cover;" class="rounded-circle img-fluid" />
                  <h5 class="card-title mt-3">{{ $file->nama }}</h5>
                  <a data-id="{{ Crypt::encrypt($file->id_footer) }}" htype="button" data-bs-toggle="modal" data-bs-target="#editupload" data-bs-whatever="@getbootstrap" class="upload btn btn-primary  d-block w-100">Edit</a>
                </div>
              </div>
            </div>
            @endif
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $title->keterangan }}" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" readonly />
                      <a data-id="{{ Crypt::encrypt($title->id_footer) }}" class="edit btn bg-primary text-light" type="button" data-bs-toggle="modal" data-bs-target="#edittext" data-bs-whatever="@getbootstrap">
            ...
            <div class="col-lg-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  @foreach ($footer as $copyright )
                  @if ($copyright->jenis == 'Copyright')
                  <div class="form-group">
                    <label for="recipient-name" class="mb-2">{{ $copyright->nama }} :</label>
                    <div class="input-group mb-3">
                    <input type="text" value="{{ $copyright->keterangan }}" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" readonly />
                      <a data-id="{{ Crypt::encrypt($copyright->id_footer) }}" class="edit btn bg-primary text-light" type="button" data-bs-toggle="modal" data-bs-target="#edittext" data-bs-whatever="@getbootstrap">
                      <i class="ti ti-pencil"></i>
                      </a>
                    </div>
                  </div>
